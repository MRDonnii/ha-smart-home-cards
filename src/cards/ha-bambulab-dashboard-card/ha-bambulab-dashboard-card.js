...
class HABambuLabDashboardCard extends HTMLElement {
  ...
  _build() {
    ...
    const heroHtml = `<section class="hero"><div class="hero-top"><div class="hero-primary"><div><span class="hero-label">Aktuelt print</span><strong class="task" data-value="task">—</strong><small data-value="stage">—</small></div></div><div class="hero-stats"><div><span>Lag</span><strong data-value="layers">—</strong></div><div><span>Resterende</span><strong data-value="remaining">—</strong></div><div><span>Færdig</span><strong data-value="end">—</strong></div><div><span>Dyse</span><strong><b data-value="nozzle">—</b>° <small>/ <span data-value="nozzle-target">—</span>°</small></strong></div><div><span>Printbed</span><strong><b data-value="bed">—</b>° <small>/ <span data-value="bed-target">—</span>°</small></strong></div><div><span>Strøm nu</span><strong data-value="power">—</strong></div></div></div><div class="print-status"><div class="print-status-meta"><span><i></i><b data-value="progress-status">Afventer</b></span><strong data-value="progress">—</strong></div><div class="print-status-bar"><i><b></b></i></div></div></section>`;
