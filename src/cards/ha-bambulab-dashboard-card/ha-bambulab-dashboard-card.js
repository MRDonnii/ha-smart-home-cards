...
class HABambuLabDashboardCard extends HTMLElement {
  ...
  _build() {
    ...
    const heroHtml = `<section class="hero"><div class="hero-primary"><div><span class="hero-label">Aktuelt print</span><strong class="task" data-value="task">—</strong><small data-value="stage">—</small></div><div class="hero-progress"><strong data-value="progress">—</strong><div class="progress"><i></i></div></div></div><div class="hero-stats"><div><span>Lag</span><strong data-value="layers">—</strong></div><div><span>Resterende</span><strong data-value="remaining">—</strong></div><div><span>Færdig</span><strong data-value="end">—</strong></div><div><span>Dyse</span><strong><b data-value="nozzle">—</b>° <small>/ <span data-value="nozzle-target">—</span>°</small></strong></div><div><span>Printbed</span><strong><b data-value="bed">—</b>° <small>/ <span data-value="bed-target">—</span>°</small></strong></div><div><span>Strøm nu</span><strong data-value="power">—</strong></div></div></section>`;
    ...
    this.shadowRoot.innerHTML = `<style>
      ...
      .main{display:grid;gap:10px}.main.no-camera{grid-template-columns:1fr}.hero{display:grid;grid-template-columns:minmax(210px,.75fr) minmax(0,1.55fr);align-items:stretch;gap:8px;padding:8px;border:1px solid var(--edge);border-radius:16px;background:linear-gradient(120deg,color-mix(in srgb,var(--accent) 9%,var(--surface)),color-mix(in srgb,var(--surface) 95%,black 5%));overflow:hidden}.hero-primary{display:flex;align-items:center;justify-content:space-between;gap:12px;min-width:0;padding:3px 7px}.hero-primary>div:first-child{min-width:0}.hero-label,.hero-stats span{display:block;color:var(--muted);font-size:7px;font-weight:800;letter-spacing:.06em;text-transform:uppercase}.hero .task{display:block;overflow:hidden;margin-top:2px;font-size:14px;font-weight:850;text-overflow:ellipsis;white-space:nowrap}.hero-primary small{display:block;overflow:hidden;margin-top:2px;color:var(--muted);font-size:8px;text-overflow:ellipsis;text-transform:capitalize;white-space:nowrap}.hero-progress{min-width:76px;text-align:right}.hero-progress>strong{font-size:20px}.progress{height:5px;overflow:hidden;margin-top:5px;border-radius:8px;background:rgba(255,255,255,.12)}.progress i{display:block;width:var(--progress,0%);height:100%;border-radius:inherit;background:linear-gradient(90deg,var(--accent),var(--good));box-shadow:0 0 12px var(--accent);transition:width .8s ease}.hero-stats{display:grid;grid-template-columns:repeat(6,minmax(0,1fr));gap:5px}.hero-stats>div{min-width:0;padding:7px 8px;border-radius:10px;background:rgba(255,255,255,.035)}.hero-stats strong{display:block;overflow:hidden;margin-top:3px;font-size:11px;text-overflow:ellipsis;white-space:nowrap}.hero-stats small{color:var(--muted);font-size:7px}.workspace{display:grid;grid-template-columns:minmax(0,1.14fr) minmax(270px,.86fr);gap:13px;margin-top:13px;align-items:start}.bambu,.ams-side{display:grid;gap:10px}.visual,.panel{border:1px solid var(--edge);border-radius:18px;background:color-mix(in srgb,var(--surface) 91%,black 9%);overflow:hidden}.visual{position:relative;min-height:330px}.visual img{display:block;width:100%;height:100%;min-height:330px;object-fit:cover;background:#080b0f}.panel{padding:13px}.panel-title{display:flex;align-items:center;gap:7px;margin-bottom:10px;color:var(--muted);font-size:9px;font-weight:900;letter-spacing:.09em;text-transform:uppercase}.panel-title ha-icon{--mdc-icon-size:17px;color:var(--accent)}.metric{position:relative;min-width:0;padding:10px;border-left:3px solid var(--tone,var(--accent));border-radius:11px;background:linear-gradient(145deg,color-mix(in srgb,var(--tone,var(--accent)) 8%,transparent),rgba(255,255,255,.02))}.metric span{display:block;color:var(--muted);font-size:8px}.metric strong{display:block;overflow:hidden;margin-top:4px;font-size:15px;text-overflow:ellipsis;white-space:nowrap}.trays{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:6px}.tray{position:relative;min-width:0;padding:9px 9px 9px 13px;border-radius:10px;background:rgba(255,255,255,.035)}.tray i{position:absolute;left:0;top:7px;bottom:7px;width:4px;border-radius:4px;background:var(--tray);box-shadow:0 0 8px var(--tray)}.tray span,.tray strong{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.tray span{color:var(--muted);font-size:7px}.tray strong{margin-top:3px;font-size:10px}.fans{display:grid;gap:7px}.fan{display:grid;grid-template-columns:30px 1fr auto;align-items:center;gap:8px;width:100%;padding:9px;border:0;border-radius:11px;background:rgba(255,255,255,.035);color:inherit;text-align:left;cursor:pointer}.fan ha-icon{color:var(--accent)}.fan.on ha-icon{animation:spin 1.2s linear infinite}.fan span{font-size:9px;color:var(--muted)}.fan strong{font-size:11px}.energy{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:8px}.energy .metric{padding:11px}.controls{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:7px}.controls button{display:flex;align-items:center;justify-content:center;gap:6px;min-height:43px;padding:7px;border:1px solid var(--edge);border-left:3px solid var(--tone,var(--accent));border-radius:12px;background:color-mix(in srgb,var(--tone,var(--accent)) 8%,var(--surface));cursor:pointer;font-size:9px;font-weight:800}.controls button:hover{background:color-mix(in srgb,var(--tone,var(--accent)) 15%,var(--surface))}.controls button ha-icon{--mdc-icon-size:18px}.controls .danger{--tone:var(--danger)}.controls .good{--tone:var(--good)}.controls .warn{--tone:var(--warn)}.controls button[disabled]{opacity:.38;cursor:not-allowed}.printing .title-icon{animation:printerFloat 2.8s ease-in-out infinite}.printing .progress i{animation:flow 1.5s linear infinite;background-size:180% 100%}.no-animation *{animation:none!important;transition:none!important}@keyframes pulse{50%{opacity:.4;transform:scale(1.5)}}@keyframes printerFloat{50%{transform:translateY(-3px);filter:drop-shadow(0 0 8px var(--accent))}}@keyframes flow{to{background-position:-180% 0}}@keyframes spin{to{transform:rotate(360deg)}}
