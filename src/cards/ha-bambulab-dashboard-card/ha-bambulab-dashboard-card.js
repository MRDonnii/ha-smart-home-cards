...
class HABambuLabDashboardCard extends HTMLElement {
  ...
  _build() {
    ...
    this.shadowRoot.innerHTML = `<style>
      ...
      @media(min-width:761px){.title-icon{width:52px;height:52px;border-radius:16px}.title-icon ha-icon{--mdc-icon-size:31px}.eyebrow{font-size:10px}.title h2{font-size:27px}.title small{font-size:13px;line-height:1.35}.health{padding:10px 14px;font-size:12px}.health i{width:9px;height:9px}.top-fans{grid-template-columns:repeat(3,minmax(130px,1fr));padding:6px}.top-fans .fan{grid-template-columns:32px minmax(0,1fr) auto;min-height:48px;padding:7px 9px}.top-fans .fan-icon{width:32px;height:32px}.top-fans .fan ha-icon{--mdc-icon-size:20px}.top-fans .fan-copy>b{font-size:10px}.top-fans .fan-copy>small{margin-top:6px}.top-fans .fan-copy i{height:3px}.top-fans .fan strong{font-size:11px}.hero{padding:17px 18px 15px}.hero-top{grid-template-columns:minmax(380px,1.15fr) minmax(0,1fr);gap:16px}.hero-machine{flex-basis:58px;width:58px;height:58px;border-radius:17px}.hero-machine ha-icon{--mdc-icon-size:33px}.hero-label{font-size:10px}.hero .task{display:block;overflow:visible;font-size:20px;line-height:1.22;white-space:normal;overflow-wrap:anywhere}.hero-primary small{margin-top:6px;font-size:11px}.hero-primary small ha-icon{--mdc-icon-size:15px}.hero-stats{grid-template-columns:repeat(3,minmax(0,1fr));grid-auto-rows:1fr;gap:8px}.hero-stats>div{padding:12px 11px}.hero-stats>div>span{font-size:10px}.hero-stats>div>span ha-icon{--mdc-icon-size:16px}.hero-stats strong{margin-top:7px;font-size:16px}.hero-stats small{font-size:10px}.print-status{padding:11px 13px 12px}.print-status-meta{margin-bottom:9px;font-size:11px}.print-status-meta span small{font-size:9px}.print-status-meta>strong{font-size:19px}.print-status-bar{height:13px}}
