...
class HABambuLabDashboardCard extends HTMLElement {
  ...
  _update() {
    ...
    card.classList.toggle("printing", active); card.classList.toggle("no-animation", this._config.animation === false);
