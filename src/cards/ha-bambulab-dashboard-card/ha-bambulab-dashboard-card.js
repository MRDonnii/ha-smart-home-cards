...
class HABambuLabDashboardCard extends HTMLElement {
  ...
  _build() {
    ...
    this.shadowRoot.innerHTML = `<style>
      ...
      @media(min-width:761px){.title-icon{width:52px;height:52px;border-radius:16px}.title-icon ha-icon{--mdc-icon-size:31px}.eyebrow{font-size:10px}.title h2{font-size:27px}.title small{font-size:12px;line-height:1.35}.health{padding:10px 14px;font-size:12px}.health i{width:9px;height:9px}.top-fans{grid-template-columns:repeat(3,minmax(130px,1fr));padding:6px}.top-fans .fan{grid-template-columns:32px minmax(0,1fr) auto;min-height:48px;padding:7px 9px}.top-fans .fan-icon{width:32px;height:32px}.top-fans .fan ha-icon{--mdc-icon-size:20px}.top-fans .fan-copy>b{font-size:9px}.top-fans .fan-copy>small{margin-top:6px}.top-fans .fan-copy i{height:3px}.top-fans .fan strong{font-size:10px}.hero{padding:17px 18px 15px}.hero-top{grid-template-columns:minmax(380px,1.15fr) minmax(0,1fr);gap:16px}.hero-machine{flex-basis:58px;width:58px;height:58px;border-radius:17px}.hero-machine ha-icon{--mdc-icon-size:33px}.hero-label{font-size:9px}.hero .task{display:block;overflow:visible;font-size:20px;line-height:1.22;white-space:normal;overflow-wrap:anywhere}.hero-primary small{margin-top:6px;font-size:10px}.hero-primary small ha-icon{--mdc-icon-size:15px}.hero-stats{grid-template-columns:repeat(3,minmax(0,1fr));gap:8px}.hero-stats>div{padding:12px 11px}.hero-stats span{font-size:9px}.hero-stats span ha-icon{--mdc-icon-size:15px}.hero-stats strong{margin-top:7px;font-size:16px}.hero-stats small{font-size:9px}.print-status{padding:11px 13px 12px}.print-status-meta{margin-bottom:9px;font-size:10px}.print-status-meta span small{font-size:8px}.print-status-meta>strong{font-size:19px}.print-status-bar{height:13px}}
      ...
      @media(max-width:980px){.hero-top{grid-template-columns:1fr}.hero-stats{grid-template-columns:repeat(3,minmax(0,1fr))}.workspace{grid-template-columns:minmax(0,1fr) minmax(300px,.82fr)}}@media(max-width:760px){.shell{padding:13px}.head{grid-template-columns:minmax(0,1fr) auto;align-items:flex-start}.top-fans{grid-column:1/-1;grid-row:2;width:100%;grid-template-columns:repeat(3,minmax(0,1fr))}.title h2{font-size:18px}.title small{max-width:210px}.workspace{display:flex;flex-direction:column}.ams-side{display:contents}.ams-card-host{order:1}.bambu{order:2}.ams-side>.panel{order:3}.ams-side>.energy-panel{order:4}.ams-side>.controls-panel{order:5}.ams-side>.energy-panel,.ams-side>.controls-panel{align-self:stretch;width:100%;max-width:100%;min-width:0}.energy-panel .energy,.controls-panel .controls{width:100%;min-width:0}.controls button{overflow:hidden}.controls button span{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.visual,.visual img{min-height:220px}.hero-stats{grid-template-columns:repeat(3,minmax(0,1fr));gap:6px}.hero-stats>div{min-height:0;padding:8px 7px}.hero-stats span{gap:4px;font-size:7px;letter-spacing:.035em}.hero-stats span ha-icon{--mdc-icon-size:12px}.hero-stats strong{margin-top:5px;font-size:12px}.hero-stats small{font-size:7px}.energy{grid-template-columns:repeat(2,1fr)}.controls{grid-template-columns:repeat(2,minmax(0,1fr))}}@media(prefers-reduced-motion:reduce){*{animation:none!important;transition:none!important}}
