...
class HABambuLabDashboardCard extends HTMLElement {
  ...
  _setMedia() {
    ...
    const entity = this._config.camera || this._config.image; if (!entity) return;
  ...
  _click(event) {
    ...
    else if (action === "power" && confirm(this._active() ? "Printeren arbejder. Vil du virkelig afbryde strømmen?" : "Sluk strømmen til 3D-printeren?")) this._call(this._config.power_switch,"switch","turn_off");
  }
}
