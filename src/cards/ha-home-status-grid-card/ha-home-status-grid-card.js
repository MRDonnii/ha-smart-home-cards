...
class HaHomeDesktopLayoutCard extends HTMLElement {
  ...
  static getStubConfig(){return{columns:"minmax(0,.9fr) minmax(440px,1.1fr)",gap:"clamp(10px,.75vw,18px)",bottom_gap:110,mobile_breakpoint:1100,header_cards:[],left_cards:[],right_cards:[],mobile_cards:[]};}
}
