...
const SECURITY_CENTER_VERSION = "0.3.3";
...
class HaSecurityCenterCard extends HTMLElement {
  ...
  _render() {
    ...
    this._commit(`<style>
      ...
      .shell{--accent:${mode === "danger" ? "var(--dashboard-danger, var(--error-color, #ff626f))" : mode === "home" ? "var(--dashboard-warning, var(--warning-color, #ffbd59))" : mode === "safe" ? "var(--dashboard-success, var(--success-color, #5edbb0))" : "var(--dashboard-accent, var(--info-color, #68b8ff))"};position:relative;isolation:isolate;overflow:hidden;padding:28px;border:1px solid rgba(132,173,210,.22);border-radius:30px;background:radial-gradient(circle at 88% 3%,color-mix(in srgb,var(--accent) 14%,transparent),transparent 30%),linear-gradient(145deg,#0d1c2b,#07121f);box-shadow:0 24px 60px rgba(0,0,0,.3)}
      .shell:before{content:"";position:absolute;inset:0;z-index:-1;opacity:.17;background-image:linear-gradient(rgba(255,255,255,.025) 1px,transparent 1px),linear-gradient(90deg,rgba(255,255,255,.025) 1px,transparent 1px);background-size:40px 40px}
      header{display:flex;justify-content:space-between;align-items:flex-start;gap:22px;margin-bottom:20px}.eyebrow{display:flex;align-items:center;gap:9px;color:var(--accent);font-size:11px;font-weight:800;letter-spacing:.18em;text-transform:uppercase}.pulse{width:8px;height:8px;border-radius:50%;background:var(--accent);box-shadow:0 0 14px var(--accent)}h1{margin:7px 0 4px;font-size:clamp(29px,3.2vw,44px);line-height:1;letter-spacing:-.045em}.subtitle{color:#8b9db1;font-size:14px}.summary{display:flex;gap:8px}.sum{min-width:105px;padding:11px 13px;border:1px solid rgba(145,174,203,.16);border-radius:15px;background:rgba(255,255,255,.035)}.sum span{display:block;color:#8193a7;font-size:9px;font-weight:800;letter-spacing:.1em;text-transform:uppercase}.sum strong{display:block;margin-top:5px;font-size:17px}.warn{color:var(--dashboard-warning, var(--warning-color, #ffbd59))!important}.danger{color:var(--dashboard-danger, var(--error-color, #ff6f79))!important}
      .hero{position:relative;overflow:hidden;display:grid;grid-template-columns:240px minmax(0,1fr);gap:24px;padding:22px;border:1px solid color-mix(in srgb,var(--accent) 36%,rgba(145,174,203,.15));border-radius:24px;background:linear-gradient(145deg,rgba(25,42,58,.92),rgba(10,22,34,.95))}.visual{display:grid;place-items:center;min-height:210px}.radar{position:relative;display:grid;place-items:center;width:158px;height:158px;border-radius:50%;border:1px solid color-mix(in srgb,var(--accent) 30%,transparent);background:radial-gradient(circle,color-mix(in srgb,var(--accent) 15%,transparent),transparent 63%)}.radar:before,.radar:after{content:"";position:absolute;border-radius:50%;border:1px solid color-mix(in srgb,var(--accent) 25%,transparent);animation:breathe 3s ease-in-out infinite}.radar:before{inset:16px}.radar:after{inset:-12px;animation-delay:1s}.radar ha-icon{--mdc-icon-size:62px;color:var(--accent);filter:drop-shadow(0 0 13px color-mix(in srgb,var(--accent) 60%,transparent))}.shell.danger-mode .radar{animation:alarm 1.1s ease-in-out infinite}.hero-body{display:flex;flex-direction:column;justify-content:center;min-width:0}.state-label{color:#8193a7;font-size:10px;font-weight:800;letter-spacing:.13em;text-transform:uppercase}.state-title{margin-top:5px;font-size:30px;font-weight:800;letter-spacing:-.035em}.state-copy{margin-top:4px;color:#94a6b9;font-size:13px}.changed{margin-top:12px;color:#708398;font-size:11px}.modes{display:grid;grid-template-columns:repeat(3,1fr);gap:9px;margin-top:22px}.mode{display:flex;align-items:center;gap:9px;min-height:58px;padding:10px 12px;border:1px solid rgba(145,174,203,.15);border-radius:14px;background:rgba(255,255,255,.035);color:#9bacc0;cursor:pointer;transition:.2s ease}.mode:hover{transform:translateY(-2px);border-color:color-mix(in srgb,var(--tone) 48%,transparent)}.mode.active{color:#fff;border-color:color-mix(in srgb,var(--tone) 52%,transparent);background:color-mix(in srgb,var(--tone) 14%,transparent);box-shadow:0 0 22px color-mix(in srgb,var(--tone) 10%,transparent)}.mode.disabled{cursor:default;opacity:.4}.mode.disabled:hover{transform:none;border-color:rgba(145,174,203,.15)}.mode ha-icon{--mdc-icon-size:22px;color:var(--tone)}.mode b{font-size:12px}
      .section-title{display:flex;align-items:center;justify-content:space-between;margin:24px 2px 10px}.section-title h2{margin:0;font-size:14px;letter-spacing:.02em}.section-title span{color:#7d90a5;font-size:11px}.systems{display:grid;grid-template-columns:repeat(auto-fit,minmax(min(100%,260px),1fr));gap:12px}.system,.access,.open-panel{border:1px solid rgba(145,174,203,.15);border-radius:19px;background:linear-gradient(145deg,rgba(255,255,255,.05),rgba(255,255,255,.022))}.system{display:flex;align-items:center;gap:13px;padding:15px;cursor:pointer}.system-icon{display:grid;place-items:center;width:42px;height:42px;border-radius:13px;background:color-mix(in srgb,var(--color) 14%,transparent);color:var(--color)}.system-icon ha-icon{--mdc-icon-size:23px}.system b{display:block;font-size:14px}.system small{display:block;margin-top:3px;color:#8193a7}.system-state{margin-left:auto;color:var(--color);font-size:11px;font-weight:800;text-transform:uppercase}
      .access-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(min(100%,145px),1fr));gap:10px}.access{position:relative;min-height:135px;padding:14px;overflow:hidden}.access ha-icon{--mdc-icon-size:28px;color:var(--color)}.access b{display:block;margin-top:20px;font-size:13px}.access span{display:block;margin-top:4px;color:var(--color);font-size:11px;font-weight:750}.access .meta{display:flex;gap:9px;flex-wrap:wrap;margin-top:7px}.access .meta span{display:inline-flex;align-items:center;gap:3px;color:#8193a7;font-size:10px;font-weight:700}.access .meta ha-icon{--mdc-icon-size:12px;color:#8193a7}.access.has-error{animation:access-error-pulse 1.8s ease-in-out infinite}@keyframes access-error-pulse{0%,100%{box-shadow:0 0 0 0 color-mix(in srgb,var(--dashboard-danger, var(--error-color, #ff626f)) 0%,transparent)}50%{box-shadow:0 0 0 3px color-mix(in srgb,var(--dashboard-danger, var(--error-color, #ff626f)) 30%,transparent)}}.lock-action{position:absolute;right:10px;bottom:10px;display:grid;place-items:center;width:32px;height:32px;border:1px solid rgba(145,174,203,.17);border-radius:10px;background:rgba(255,255,255,.045);cursor:pointer}.lock-action ha-icon{--mdc-icon-size:17px}.open-panel{padding:16px;cursor:pointer}.open-head{display:flex;align-items:center;gap:12px}.open-head>ha-icon{--mdc-icon-size:27px;color:${openings.length ? "var(--dashboard-warning, var(--warning-color, #ffbd59))" : "var(--dashboard-success, var(--success-color, #5edbb0))"}}.open-head b{display:block;font-size:15px}.open-head span{display:block;margin-top:2px;color:#8294a8;font-size:11px}.chevron{margin-left:auto;color:#7890a7}.open-list{display:grid;grid-template-columns:repeat(auto-fit,minmax(min(100%,150px),1fr));gap:7px;margin-top:13px}.opening{display:flex;align-items:center;gap:7px;padding:8px 9px;border-radius:10px;background:rgba(255,189,89,.08);color:var(--dashboard-warning, var(--warning-color, #ffca75));font-size:11px}.opening ha-icon{--mdc-icon-size:15px}.empty{margin-top:12px;color:var(--dashboard-success, var(--success-color, #69d8b1));font-size:12px}
      .access[data-lock]{cursor:pointer;transition:transform .18s ease,border-color .18s ease,background .18s ease}.access[data-lock]:hover,.access[data-lock]:focus-visible{transform:translateY(-2px);border-color:color-mix(in srgb,var(--color) 52%,transparent);background:color-mix(in srgb,var(--color) 9%,rgba(255,255,255,.03));outline:none}.access[data-lock] .lock-action{pointer-events:none}
