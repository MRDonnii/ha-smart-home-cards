...
class HaHomeDesktopLayoutCard extends HTMLElement {
  ...
  _observeMobile(){const mobile=this.shadowRoot?.querySelector(".mobile");if(!mobile||!window.ResizeObserver)return;this._ro?.disconnect();this._ro=new ResizeObserver(()=>this._scheduleFill());this._ro.observe(mobile);}
