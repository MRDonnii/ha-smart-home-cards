...
class HaHomeDesktopLayoutCard extends HTMLElement {
  constructor(){super();this.attachShadow({mode:"open"});this._children=[];this._headerChildren=[];this._desktopChildren=[];this._mobileChildren=[];this._verticalChildren=[];this._mqList=[];this._resize=()=>requestAnimationFrame(()=>this._fitViewport());this._onBreakpoint=()=>this._flushActive();this._slots={header_cards:[],left_cards:[],right_cards:[],mobile_cards:[],vertical_cards:[]};this._slotSig={header_cards:[],left_cards:[],right_cards:[],mobile_cards:[],vertical_cards:[]};this._mode="cards";}
  _applyMode(){
