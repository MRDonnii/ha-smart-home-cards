...
class HAElectricityPriceCard extends HTMLElement {
  ...
  _render() {
    ...
    card.style.height = compactMobile ? "330px" : fillHeight ? "100%" : `${desktopHeight}px`;
    ...
    if (chart) {
      if (fillHeight) {
        ...
        chart.style.height = `${188 + headerGain}px`;
