...
class HAElectricityPriceCard extends HTMLElement {
  ...
  _render() {
    ...
    this.shadowRoot.innerHTML = `<style>
      ...
      /* Mobil: rammen slutter tæt om periodeknapperne uden luft, baggrund eller skygge, og den valgte knaps kant ligger oven på rammen. */
      ...
      /* Telefon: fanerne rykker op, så der er lige langt fra rammen til kortets top og sider. */
